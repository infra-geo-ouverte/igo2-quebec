 ...
 */
@Component({
  selector: 'app-sidesearch-bar',
  templateUrl: './sidesearch-bar.component.html',
  styleUrls: ['./sidesearch-bar.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SideSearchBarComponent implements OnInit, OnDestroy {
  /**
   * Invalid keys
   */
  static invalidKeys = [
